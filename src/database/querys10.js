export const queries10 = {
    getConsultaLoteVenta: 'SELECT * FROM [Lotes_pollos].[dbo].[Lote_venta]',
    ...
    'SELECT [Id_lote_venta_total],[Id_ref_lote],[Total_pollos_vendidos],[Peso_total_vendido],[Valor_promedio_peso],[Total_venta_lote],[Ganancia_bruta],Promedio_total_peso,[Promedio_venta_pollo],[Cantidad_ventas],SUM(gv.Cantidad * gv.Precio) gastos_ventas FROM Lote_venta Inner join [dbo].[Gastos_ventas] gv on Id_ref_lote_venta = Id_lote_venta_total WHERE Id_ref_lote = @Id_ref group by [Id_lote_venta_total],[Id_ref_lote],[Total_pollos_vendidos],[Peso_total_vendido],[Valor_promedio_peso],[Total_venta_lote],[Ganancia_bruta],Promedio_total_peso,[Promedio_venta_pollo],[Cantidad_ventas]',

    getConsultaFechaVentaLotes:
    "select Fecha_entrada_pollos from Lote_produccion inner join [dbo].[Lote_venta] lv on  lv.Id_ref_lote =  Lote_produccion.Id_ref_lote WHERE  Id_lote_venta_total = @Id",

export const queries13 = {
    ...
    getConsultaLotes: 'SELECT * FROM [Lotes_pollos].[dbo].[Lotes]',
    ...
    'select  Id_lote,Fecha_creacion_lote_sistema, Fecha_terminacion_lote_sistema, Estado_lote, Nombre_usuario from Lotes  inner join [dbo].[Usuarios] u on  u.Id_usuario =  Id_referencia_usuario order by Fecha_creacion_lote_sistema desc',

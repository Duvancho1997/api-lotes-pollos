export const queries8 = {
    getConsultaLoteVentasRegistro: 'SELECT * FROM [Lotes_pollos].[dbo].[Lote_ventas_registro]',
    ...
    'select Fecha_venta,Identificacion_cliente, Nombre,Valor_unidad_peso,Cantidad,Cantidad_pollos,Total_venta,Id_lote_ventas_registro,Id_referencia_cliente from Lote_ventas_registro inner join [dbo].[Cliente] lv on  lv.Id_Cliente =  Id_referencia_cliente where Id_ref_lote_venta = @Id',
    }